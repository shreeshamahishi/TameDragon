...
public class Utilities {
	 ...
	 */
	public static HashMap<BasicBlock, HashSet<BasicBlock>> getDominanceFrontiers(Function function, DominatorTree dominatorTree){
	...
	public static void addToDominanceFrontier(HashMap<BasicBlock, HashSet<BasicBlock>> dominanceFrontiers,
			BasicBlock node, BasicBlock frontierMember){
