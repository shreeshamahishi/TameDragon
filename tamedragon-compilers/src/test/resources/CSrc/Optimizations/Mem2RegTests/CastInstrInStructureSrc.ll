...
define i32 @fun(i32 %x) nounwind {
  ...
  %2 = getelementptr inbounds %struct.Student* %a, i32 0, i32 0
  store i32 20, i32* %2, align 4
  %3 = getelementptr inbounds %struct.Student* %a, i32 0, i32 1
...
; <label>:14                               		; preds = %11, %8
  %15 = getelementptr inbounds %struct.Student* %c, i32 0, i32 0
