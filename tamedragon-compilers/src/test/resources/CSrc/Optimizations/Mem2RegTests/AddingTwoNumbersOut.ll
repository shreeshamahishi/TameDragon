...
define i32 @main() nounwind {
  ...
  %1 = getelementptr inbounds [22 x i8]* @.str, i32 0, i32 0
  %2 = call i32 (i8*, ...)* @printf(i8* %1)
  %3 = getelementptr inbounds [6 x i8]* @.str1, i32 0, i32 0
  %4 = call i32 (i8*, ...)* @scanf(i8* %3, i32* %first, i32* %second)
  %5 = getelementptr inbounds [29 x i8]* @.str2, i32 0, i32 0
  %6 = load i32* %first, align 4
  %7 = load i32* %second, align 4
  %8 = call i32 (i8*, ...)* @printf(i8* %5, i32 %6, i32 %7)
  %9 = load i32* %first, align 4
  %10 = load i32* %second, align 4
  %11 = add i32 %9, %10
  %12 = getelementptr inbounds [17 x i8]* @.str3, i32 0, i32 0
