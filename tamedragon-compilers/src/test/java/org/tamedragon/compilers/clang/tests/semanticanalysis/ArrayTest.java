...
public class ArrayTest extends TestInitializer {
	...
	public void setUp(){
		...
		environments.reset();		
		sourceFilePath ="CSrc/Semantic/ArrayTest.c"; 
	...
	public void test1() {      		
		...
		try{
			while(iter.hasNext()){
				...
				if(count == 1){
					assertTrue(line == 2); 
					assertTrue(msg.equals(ErrorHandler.ERROR + "arr" + ErrorHandler.E_NOT_DEFINED));
				}
