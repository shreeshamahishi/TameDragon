...
public class SimpleIncludeWithCommentTest1 extends TestInitializer {
	...
	@Before
	public void setUp(){		
		sourceFilePath ="CSrc/Preprocessor/SimpleIncludeWithCommentTest1.c"; 
	...
	public void test1() { 
		...
		String programCode = pu3.toString();

		
		assertTrue(programCode.contains("/*") && programCode.contains("*/") && programCode.contains("//"));
	}	
}
