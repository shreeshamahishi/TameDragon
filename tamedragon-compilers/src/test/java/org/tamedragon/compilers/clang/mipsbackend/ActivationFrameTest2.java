...
public class ActivationFrameTest2 {
	...
	public void testLeafProcedureAndNoStackVariablesAndOneCalleeSavedIntByteSize() {     
		...
		assertTrue(fixture.getStackSize() == 13);
		...
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 5);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 9);
	}
	...
	public void testLeafProcedureAndNoStackVariablesAndOneCalleeSavedShortIntSize() {     
		...
		assertTrue(fixture.getStackSize() == 14);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 6);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 6);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 10);
	}
	...
	/**
	 * Bare minimum stack with only one caller saved regsiter in $f20 with data of floating point size of 
	 * single precision
	 */
	@Test
	...
	public void testLeafProcedureAndNoStackVariablesAndOneCalleeSavedFloatDoublePrecision() {     
		...
		assertTrue(fixture.getStackSize() == 20);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 12);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 12);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 16);
	}
	...
	public void testNonLeafProcedureAndNoStackVariablesAndOneCalleeSavedFloatDoublePrecision() {     
		...
		assertTrue(fixture.getStackSize() == 28);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 12);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 20);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 24);
	}
	...
	public void testNonLeafProcedureAndNoStackVariablesAndMultipleSaveTypes() {     
		...
		assertTrue(fixture.getStackSize() == 47);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 21);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 39);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 43);
	}
	...
	public void testNonLeafProcedureAndSomeOutgoingArgsAndNoStackVariablesAndMultipleSaveTypes() {     
		...
		assertTrue(fixture.getStackSize() == 63);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 20);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 37);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 55);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 59);
		...
		assertTrue(fixture.getStackSize() == 66);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 20);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 39);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 58);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 62);
		...
		assertTrue(fixture.getStackSize() == 78);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 28);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 51);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 70);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 74);
	}
	
	/**
	 * Non-leaf procedure with no local variables and multiple types of caller and callee saves
	 *, saving outgoing argument and some stack variables too.
	 */
	@Test
	@Ignore
	public void testNonLeafProcedureAndSomeOutgoingArgsWithStackVariablesAndMultipleSaveTypes() {     
		...
		assertTrue(fixture.getStackSize() == 112);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 24);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 66);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_RETURN_ADDRESS) == 90);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_FRAME_POINTER) == 94);
	...
	public void testLeafProcedureAndWithStackVariablesAndMultipleSaveTypes() {     
		...
		assertTrue(fixture.getStackSize() == 46);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLEE_SAVED_REGISTERS) == 4);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_CALLER_SAVED_REGISTERS) == 24);
		assertTrue(fixture.getOffset(ActivationFrame.OFFSET_FOR_STORING_ARGUMENTS) == 4);
