...
//
//public class IFElseTest3 extends TestInitializer {
//	
...
//			
//		sourceFilePath ="CSrc/TranslationToTreeIR/IFElseTest3.c"; 
//		errorHandler = ErrorHandler.getInstance();
//		errorHandler.reset();
...
//		checkTheNosOfCJumpsStmts(allStms,4);
//		checkTheNosOfJumpsStmts(allStms,4);
//		
